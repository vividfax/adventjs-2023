...
class Day21 extends Day {
    ...
    update()
    {
        ...
        this.threeD.shader(assets.day21Shader);
        assets.day21Shader.setUniform("pointsX", this.pointsX);
        assets.day21Shader.setUniform("pointsY", this.pointsY);
        assets.day21Shader.setUniform("intensities", this.intensities);
        assets.day21Shader.setUniform("reds", this.reds);
        assets.day21Shader.setUniform("greens", this.greens);
        assets.day21Shader.setUniform("blues", this.blues);
